                            ...
                            <div className={"dash-wrapper"}>
                                <div>
                                        ...
                                        <div className="row">
                                                ...
                                                <div className="col-sm-14">
                                                    <div className="card">
                                                        <div className="card-body"
                                                             style={{background: 'rgba(14,14,14,0.82)'}}>
                                                            <center><ImBullhorn size='60px' color='white'/></center>
                                                            <center><h5 className="card-title mt-3"
                                                                        style={{color: 'white'}}>Today Notice Count</h5>
                                                            </center>
                                                            <center><h4 className="card-text"
                                                                        style={{color: 'white'}}>{this.state.noticeCount}</h4>
                                                            </center>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="col-sm-14">
                                                    <div className="card">
                                                        <div className="card-body" style={{background: '#e58e08'}}>
                                                            ...
                                                            <center><h5 className="card-title mt-3">Grades We
                                                                support</h5></center>
                                                            <center><h4
                                                                className="card-text">{this.state.gradeCount}</h4>
                                                            </center>
                                            ...
                                            <div className="col">
                                                <div className="col-sm-14">
                                                    <div className="card">
                                                        <div className="card-body"
                                                             style={{background: 'rgb(252,197,0)'}}>
                                                            <center><FaUserGraduate size='60px'/></center>
                                                            <center><h5 className="card-title mt-3">Registered
                                                                Students </h5></center>
                                                            <center><h4
                                                                className="card-text">{this.state.studentCount[0]}</h4>
                                                            </center>
                                    ...
                                    <div className="container m-4">
                                        <Button variant={"outline-warning"} onClick={onStartCapture}><FaCameraRetro size='50px'/></Button>
                                        <center>
                                            <img src={screenCapture} alt=''/>
                                            <p>
                                                {screenCapture &&
                                                <Button variant={"outline-warning"} onClick={this.handleSave}><FaCloudDownloadAlt size='50px'/>
                                                </Button>}
                                            </p>
                                        </center>
                                    </div>
